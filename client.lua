...
local txt = "" -- /me text
local bwtxt = "* Osoba vytáhne zbraň z kufru auta. "
local dbtxt = "* Osoba vytáhne zbraň z batohu. "
local dbtxterr = "Hej - tuto zbraň lze vyjmout pouze z auta nebo z dufflebagu."
local bwtxterr = "Hej - tuto zbraň lze vyjmout pouze z auta."
local swtxt = " Osoba vytáhne zbraň. "
local mwtxt = " Osoba vytáhne zbraň na blízko. "
						...
						if duffle == true then
							if IsPedModel(playerPed,1885233650) and bigWeaponOut == false and GetVehiclePedIsIn(playerPed, false) == 0 then -- male
								...
								if GetPedDrawableVariation(playerPed,5) == 45 and GetPedTextureVariation(playerPed,5) == 0 and GetPedPaletteVariation(playerPed,5) == 0 then
									...
									Wait(1)
									drawNotification("~Thirst RP ~r~"..dbtxterr.."")
								...
								if IsPedModel(playerPed,-1667301416) and bigWeaponOut == false and GetVehiclePedIsIn(playerPed, false) == 0 then -- female
									...
									Wait(1)
									drawNotification("~p~Thirst RP ~r~"..dbtxterr.."")
									SetCurrentPedWeapon(playerPed, -1569615261)
									end
								end
							end
							...
							if bigWeaponOut == false and GetVehiclePedIsIn(playerPed, false) == 0 then
								Wait(1)
								drawNotification("~p~Thirst RP ~r~"..bwtxterr.."")
								SetCurrentPedWeapon(playerPed, -1569615261)
							end
						end
					end
